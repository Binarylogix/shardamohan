...
const Aboutus = () => {
  return (
    <div className="mt-6">
      ...
      <div className=" flex flex-col lg:flex-row ld:px-32 justify-between items-center  gap-5">
        <div className=" bg-[url('assets/img/bgAbout.png')] bg-no-repeat bg-cover flex flex-col lg:flex-row p-2 md:p-12 lg:px-28 gap-5">
          <div className=" w-full lg:w-3/4 p-4 rounded-xl shadow-lg space-y-4 ">
            <div
              className="bg-cover bg-center p-8 md:w-64"
            ...
            <p className="text-justify lg:text-start text-sm">
              ShardaMohan Clinic comes forward with a holistic approach to treat patients with personalized Constitutional Homeopathic Treatment that serves to be far better than the conventional treatments. It consists of well experienced Homeopathic doctor Parul Agrawal who happen to be expert.
            </p>
          </div>
